...
// Name        : Temp3.cpp
// Author      : GHZ
// Description : Version #3 - class example for comparing temperature in (F), (C), & (K)
//============================================================================
#include <iostream>
#include <iomanip>
#include <cmath>
...
class Temperature
{
	private:
		double myDegrees;
		char myScale;
		double getDegrees();		// moved to private
		char getScale();			// moved to private
		void setDegrees(double);	// moved to private
		void setScale(char);		// moved to private
